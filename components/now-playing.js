    ...
    <div className="flex mb-4 flex-row flex-start border border-white rounded p-2 w-300px">
      ...
      <div className="justify-center flex flex-start flex-col mx-3">
        <Link href={data?.songUrl || ''}>
          <p className="text-white text-opacity-50 font-medium max-w-190px whitespace-no-wrap overflow-hidden overflow-ellipsis">
            {data ? data.title : 'Not Playing'}
          </p>
        </Link>
        <p className="text-white mb-4 max-w-190px whitespace-no-wrap overflow-hidden overflow-ellipsis">
