...
export default function manifestoPage() {
    return (
        <>
            ...
            <h2 className="text-5xl text-left text-red-400 font-bold font-sans leading-none pb-4 pt-16">
                Pondering and Contemplation
                <br />
                about <span className="underline dotted">Resourcefulness</span> and <span className="underline dotted">Inventiveness</span>.
            </h2>
            ...
            <h2 className="text-2xl text-left text-yellow-400 font-bold font-sans leading-none py-4">The Test</h2>
            <h3 className="text-left text-white text-xl font-sans leading-normal pt-4 md:max-w-screen-sm lg:max-w-screen-sm">
                <p className="story">
            ...
            <h2 className="text-2xl text-left text-green-400 font-bold font-sans leading-none py-4">Adjectives</h2>
            <h3 className="text-left text-white text-xl font-sans leading-normal pt-4 md:max-w-screen-sm lg:max-w-screen-sm">
            <p className="story">
            ...
            <h2 className="text-2xl text-left text-blue-400 font-bold font-sans leading-none py-4">Imminent Questioning and Regret</h2>
            <h3 className="text-left text-white text-xl font-sans leading-normal pt-4 md:max-w-screen-sm lg:max-w-screen-sm">
            <p className="story">
            ...
            <p className="story">
                As I mold the Play-Doh of my memories into complex, three-dimensional structures, I think about what I've done to get to the point I'm at, and what I can do to become better. Whether that be the obvious or the opinionated, I strive to become more <span className="text-pink-400 underline">inventive</span> and <span className="text-pink-400 underline">resourceful</span> on my journey throughout life. So come, think and create with me!
            </p>
        </h3>
                <Signature />
                <Social />
